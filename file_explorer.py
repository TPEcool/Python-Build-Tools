...
def init(win: Frame, file_menu: Menu):
    ...
    _ICONS = {
        'folder_empty': Image.open(os.path.join(getcwd(), 'resources', 'folder.png')),
        'folder': Image.open(os.path.join(getcwd(), 'resources', 'folder_files.png')),
        'text': Image.open(os.path.join(getcwd(), 'resources', 'text.png')),
        'up': Image.open(os.path.join(getcwd(), 'resources', 'up.png')),
        'unknown': Image.open(os.path.join(getcwd(), 'resources', 'unknown.png')),
        'export': Image.open(os.path.join(getcwd(), 'resources', 'export.png')),
        'run': Image.open(os.path.join(getcwd(), 'resources', 'run.png')),
        'tofolder': Image.open(os.path.join(getcwd(), 'resources', 'export_tofolder.png')),
        'zip': Image.open(os.path.join(getcwd(), 'resources', 'export_zip.png'))
    }
    ...
    Button(win, image=ICONS['up'], command=go_up, style=DARK).pack(side=LEFT, expand=True, anchor=NW)
    ...
    pathsel.pack(side=RIGHT, expand=True, fill=X, ipadx=5000, anchor=N)
    ...
    global nofileicon
    nofileicon = ImageTk.PhotoImage(file=os.path.join(getcwd(), 'resources', 'nofile.png'))
