...
tabs.add(explorertab, text='Asset explorer')
...
Menubutton(explorertab, menu=explorer_filemenu, text='File', style=LIGHT+OUTLINE).pack(side=TOP, fill=X, anchor=N, expand=True)
